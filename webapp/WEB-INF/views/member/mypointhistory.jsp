   ...
   <!-- mypage -->
   	...
   	<div class="w3-container w3-padding w3-margin w3-border-indigo w3-card-4" style="padding:128px 16px">
			...
			<div class="w3-rest w3-text-grey">
				...
				<div class="w3-col  "> 
				<h4><span class="w3-col m2">가입일 :</span><span class="w3-rest" id="id">${DATA.sdate}</span></h4>
				</div>
				<div class="w3-col "> 
   ...
   <div class="w3-container w3-padding w3-margin w3-border-indigo w3-card-4" style="padding:128px 16px">
  	 ...
  	 <!-- 보여질 기능들 -->
		<div class="w3-rest w3-text-grey w3-margin-left">
			...
			<div class="w3-button w3-hover-blue w3-indigo btnbox parent" id="board">전체내역</div>
			<div class="w3-button w3-hover-blue w3-indigo btnbox parent" id="reply">충전내역</div>
...
<c:choose>
	...
	<c:otherwise>
			<div class="w3-col m2 w3-left"><div class="btnbox w3-pink parent">에러!!</div></div>
	</c:otherwise>
</c:choose>
			<div class="w3-col m6 w3-center">${data.det}</div>  
   ...
   <footer class="w3-container w3-margin-top w3-padding-64 w3-center w3-opacity w3-border-top">
    ...
    <!-- 데이터 전송용 form 태그 -->
	<form method="POST" action="/boara/member/mypointhistory.boa" id="frm" name="frm">
